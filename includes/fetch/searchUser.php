 ...
 foreach($count as $row) 
 {
  $output .= '
   <tr>
	...
	<td>'.$row["email"].'</td>
	<td>'.$row["telephone"].'</td>
	<td><a href="#edituser" data-toggle="modal" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-pencil"></span> Επεξεργασία</a> </td>
   </tr>
  ';
...
include('../includes/edits/editUser.php'); 
