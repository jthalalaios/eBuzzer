...
$total_price=0;
$conn=db_open();
if(isset($_POST['order_id_info']) && ($_POST['esp_id_info']) && ($_POST['user_id_info']))
{
	echo"edw";
	$id_u=filter_var($_POST['user_id_info']);
	$id_order=filter_var($_POST['order_id_info']);
	$id_esp=filter_var($_POST['esp_id_info']);
	try 
		{
